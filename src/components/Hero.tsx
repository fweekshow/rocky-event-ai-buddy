...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 pixelated-dots pointer-events-none z-10"></div>
      <div className="absolute inset-0 pixelated-dots-layer2 pointer-events-none z-10"></div>
      <div className="absolute inset-0 pixelated-dots-layer3 pointer-events-none z-10"></div>

      <div className="container relative mx-auto px-4 py-20">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          {/* Content */}
          <div className="flex-1 text-center lg:text-left animate-fade-in relative z-0">
          ...
          {/* Rocky Mascot */}
          <div className="flex-1 flex justify-center lg:justify-end animate-fade-in relative z-20" style={{ animationDelay: "0.2s" }}>
            <div className="relative">
              ...
              <img
                ...
                className="relative w-64 sm:w-80 lg:w-96 h-auto rounded-full animate-float z-20"
              />
            </div>
          </div>
        </div>
