      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Comprehensive tools to make the most of every event.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.1s" }}>
            <div className="mb-8">
              <h3 className="font-display text-3xl font-bold text-primary mb-2">For Attendees</h3>
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.15s" }}>
            <div className="mb-8">
              <h3 className="font-display text-3xl font-bold text-secondary mb-2">For Sponsors</h3>
